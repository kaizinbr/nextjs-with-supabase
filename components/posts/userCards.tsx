...
export default function UserCardsContainer({ posts, edit }: { posts: any[] | null, edit?: Boolean }) {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-20 px-4 md:px-0 mx-auto max-w-4xl">

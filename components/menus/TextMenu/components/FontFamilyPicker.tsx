...
const FONT_FAMILY_GROUPS = [
    ...
    },
    {
        label: "Serif",
        options: [
            { label: "LL Bradford", value: "var(--bradford-font-family)" },
            { label: "Gelica", value: "gelica" },
            { label: "Times New Roman", value: "Times" },
            { label: "Garamond", value: "Garamond" },
            { label: "Georgia", value: "Georgia" },
            { label: "Lora", value: "var(--lora-font-family)" },
        ],
    },
    {
        label: "Monospace",
...
export const FontFamilyPicker = ({
    ...
    const currentFontLabel = currentValue?.label.split(" ")[0] || "Lora";
